...
dn.set_gpu(0)
meta = dn.load_meta("darknet/darknet/cfg/coco.data")

net = dn.load_net("darknet/darknet/cfg/yolov2-tiny.cfg",
                  "darknet/darknet/yolov2-tiny.weights",0)
...
def callback(data):
	...
	#cv_image = cv2.resize(cv_image, (0, 0), fx=0.5, fy=0.5)  # resize image half

	#input_image = array_to_image(cv_image)

        #image = dn.rgbgr_image(input_image)
	...
	print(class_name,class_score,x,y,w,h)
